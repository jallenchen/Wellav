...
//        deviceRotationOffset = Integer.parseInt(TextUtils.isDigitsOnly(value3) && !TextUtils.isEmpty(value3) ? value3 : 0 + "");
        ...
        videoHwEncoderMode = 0;
        videoHwDecoderMode = 0;
        videoFpsReported = true;
        audioEffectAecMode = 2;
        audioEffectAgcMode = 2;
        audioEffectNsMode = 2;
        videoMaxBitrate = 0;
        deviceDefaultRotation = 0;
        deviceRotationOffset = 0;
    }
    ...
    @Override
    public void togglescreenshot(String account) {
    	// 截屏
