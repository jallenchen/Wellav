...
public class AVChatVideo implements View.OnClickListener, ToggleListener{
    ...
    private void findViews() {
        ...
        headImg = (CircleImageView) middleRoot.findViewById(R.id.avchat_video_head);
        ...
        screenshotImg = (ImageView) bottomRoot.findViewById(R.id.avchat_screenshot);
    ...
    private void showProfile(){
       ...
       FamilyUserInfo user =  LauncherApp.getInstance().getDBHelper().getFamilyUser(context, account);
       LoadUserAvatarFromLocal task = new LoadUserAvatarFromLocal();
       Bitmap head =  task.loadImage(account);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.avchat_video_switch_audio:
                ...
                break;
            case R.id.avchat_screenshot:
                listener.togglescreenshot(manager.getAccount());
                break;
    ...
    public void closeSession(int exitCode){
        if(init){
            time.stop();
            screenshotImg.setEnabled(false);
