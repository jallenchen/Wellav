...
public class CancelCollect {
	public interface OnCancelCollectSuccessLis{
		void onCancelCollectSuccess(List<PhotoInfo> delSrc);
	}
	...
	public static  XMLRequest newXMLRequest(final String url, String msg,
			final View v1, final View v2,final List<PhotoInfo> delSrc,final OnCancelCollectSuccessLis lis) {
		v1.setEnabled(false);
			...
			public void onResponse(XmlPullParser response) {
				...
				try {
					...
					if(result)
					{
						...
						lis.onCancelCollectSuccess(delSrc);
					}
