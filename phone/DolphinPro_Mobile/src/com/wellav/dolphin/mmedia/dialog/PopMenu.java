...
public class PopMenu {
	...
	private int[] ivId = new int[]{R.drawable.ic_addcontacts,R.drawable.ic_groupchat,R.drawable.ic_feedback,R.drawable.ic_recommend_download};
	...
	private final class PopAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				holder.gtxt = (TextView) convertView.findViewById(R.id.aname);
				holder.gicon = (ImageView) convertView.findViewById(R.id.icon);

			} else {
				holder = (ViewHolder) convertView.getTag();
			}

			holder.gtxt.setText(itemList.get(position));
			holder.gicon.setImageResource(ivId[position]);
