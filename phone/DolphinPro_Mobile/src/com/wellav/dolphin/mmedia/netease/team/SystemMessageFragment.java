...
import com.wellav.dolphin.mmedia.fragment.BaseFragment;
 ...
 */
public class SystemMessageFragment extends BaseFragment implements TAdapterDelegate,
    ...
    public static void start(Context context, Intent extras, boolean clearTop) {
        ...
        intent.setClass(context, SystemMessageFragment.class);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	View view = inflater.inflate(R.layout.system_notification_message_activity, null);
    ...
    private void initAdapter() {
        adapter = new SystemMessageAdapter(getActivity(), items, this, this);
    }
    ...
    private void onProcessFailed(final int code, SystemMessage message) {
        Toast.makeText(getActivity(), "failed, error code=" + code,
    ...
    private void deleteAllMessages() {
        ...
        items.clear();
        refresh();
        Toast.makeText(getActivity(), R.string.clear_all_success, Toast.LENGTH_SHORT).show();
    }
