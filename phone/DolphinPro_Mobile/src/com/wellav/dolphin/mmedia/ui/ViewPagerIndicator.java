...
public class ViewPagerIndicator extends LinearLayout
{
	 ...
	 * 三角形的宽度为单个Tab的1/10
	 */
	private static final float RADIO_TRIANGEL = 1.0f / 10;
	/**
	 * 三角形的最大宽度
	 */
...
//		Log.e("TAG", "onSizeChanged");
		...
		mTriangleWidth = (int) (w / mTabVisibleCount * RADIO_TRIANGEL);// 1/7 of
																		// width
	...
	{
//		Log.e("", "gv-w="+getWidth());
//		this.setWeightSum(mTabVisibleCount);
		TextView tv = new TextView(getContext());
		LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
				getScreenWidth() / mTabVisibleCount, LayoutParams.MATCH_PARENT);
...
//		lp.weight=1;
	...
	public void scroll(int position, float offset)
	{
		...
		// 容器滚动，当移动到第二个的时候，开始滚动
//		if (offset > 0 && position >=0
//				&& getChildCount() > mTabVisibleCount)
//		{
//			if (mTabVisibleCount != 1)
//			{
//				this.scrollTo((position - 0) * tabWidth
//						+ (int) (tabWidth * offset), 0);
//			} else
//			// 为count为1时 的特殊处理
//			{
